...
function paginateData(data,page,perPage) {
  // Pagination is disabled app-wide: every row is returned in one page and
  // tables scroll instead of paging, so callers still get a consistent shape.
  return {items:data,totalPages:1,total:data.length};
}
